...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
  <div class="container mt-3">
    <center><h1>Request Admin</h1></center>
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td><div class="btn-group me-2">
            <button type="button" class="btn btn-sm btn-outline-secondary">Terima</button>
            <button type="button" class="btn btn-sm btn-outline-secondary">&nbsp;Tolak</button>
          </div></td>
        </tr>
        <tr>
          <td>Mary</td>
