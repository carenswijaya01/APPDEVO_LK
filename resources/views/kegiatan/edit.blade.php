...
<body class="">
    <div class="row mt-4 p-4">
        <form action="{{ route('updateKegiatan',$keg->id)}}" method="post">
            {{ csrf_field() }}
            <h1 class="h3 mb-3 fw-normal text-center">Edit Data Kegiatan</h1>
            <div class="row justify-content-center">
                <div class="card col-6 p-4 ">
                    <div class="row justify-content-center">
                        <div class="row justify-content-center">
                            <div class="form-floating col-6">
                                <input type="text" class="form-control form-control-sm col-6" id="floatingInput" placeholder="Masukkan Nama Kegiatan" name="nama_kegiatan" value="{{$keg->nama_kegiatan}}" required>
                        ...
                        <div class="row justify-content-center mt-2">
                            <div class="form-floating col-6">
                                <input type="date" class="form-control form-control-sm col-6" id="floatingInput" placeholder="" name="tgl_kegiatan" value="{{$keg->tgl_kegiatan}}" required>
                                <label for="floatingInput" class="mx-2">Waktu Pelaksanaan</label>
                            </div>
                        </div>
                        <div class="row justify-content-center mt-2">
                            <div class="form-floating col-6">
                                <textarea type="text" class="form-control form-control-sm col-6" id="deskripsi_kegiatan" name="deskripsi_kegiatan" rows="5"  required>{{$keg->deskripsi_kegiatan}}</textarea>
