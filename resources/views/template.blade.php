    ...
    <div class="wrapper">
        ...
        <nav id="sidebar" style="overflow-x:hidden">
            <div class="sidebar-header">
                ...
                <h6 class="mt-4">{{auth()->user()->role->role}} {{auth()->user()->name}}</h6>
                                ...
                                <ul class="nav navbar-nav ml-auto">
                                    <li class="nav-item">
                                        <a class="nav-link px-3" href="{{ route('admin.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                            <button type="submit" style="border: none;" class="btn btn-md btn-logout"><i class="fa-solid fa-right-from-bracket fa-xl"></i></button>
                                        </a>
